	...
	function register_required_plugins() {
		...
		$plugins = array(
			...
			*/
			...
			// Advanced Custom Fields: Options Add On
			array(
				'name'     				=> 'Advanced Custom Fields: Options Add On', // The plugin name
			...
			array(
				'name'     				=> 'Advanced Custom Fields: Repeater Add On', // The plugin name
			...
			array(
				'name'     				=> 'Advanced Custom Fields: Gallery Add On', // The plugin name
				'slug'     				=> 'acf-gallery', // The plugin slug (typically the folder name)
				'source'   				=> get_stylesheet_directory() . '/lib/plugins/acf-gallery.zip', // The plugin source
				'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
				'version' 				=> '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
				'force_activation' 		=> true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
				'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
