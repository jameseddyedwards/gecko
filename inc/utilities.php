...
include $libPath . 'the_contact_details.php';		// Adds parent class to menu
include $libPath . 'the_slider.php';				// Adds a ACF gallery
include $libPath . 'change_menu_labels.php';		// Change "Posts" to "Blog"
include $libPath . 'create_post_types.php';			// Create new post types
